...
datas_kmer_estecio = {esteciodatak2, esteciodatak3, esteciodatak4, esteciodatak5, esteciodatak6, esteciodatak7, esteciodatak8, esteciodatak9};        
...
filename_test = sprintf('Score2_MEME_ESTECIO_CGI');
...
%% K = 2
test_datak2_prone = esteciodatak2(1:np_v,:); 
test_datak2_resistant = esteciodatak2((np_v+1):n_v,:);        
%% K = 3
test_datak3_prone = esteciodatak3(1:np_v,:); 
test_datak3_resistant = esteciodatak3((np_v+1):n_v,:);
%% K = 4
test_datak4_prone = esteciodatak4(1:np_v,:); 
test_datak4_resistant = esteciodatak4((np_v+1):n_v,:);
%% K = 5
test_datak5_prone = esteciodatak5(1:np_v,:); 
test_datak5_resistant = esteciodatak5((np_v+1):n_v,:);
%% K = 6
test_datak6_prone = esteciodatak6(1:np_v,:); 
test_datak6_resistant = esteciodatak6((np_v+1):n_v,:);
%% K = 7
test_datak7_prone = esteciodatak7(1:np_v,:); 
test_datak7_resistant = esteciodatak7((np_v+1):n_v,:);
%% K = 8
test_datak8_prone = esteciodatak8(1:np_v,:); 
test_datak8_resistant = esteciodatak8((np_v+1):n_v,:);
%% K = 9
test_datak9_prone = esteciodatak9(1:np_v,:); 
test_datak9_resistant = esteciodatak9((np_v+1):n_v,:);
...
filename_test_tfbs = sprintf('Score2_TFBS_ESTECIO_CGI');
